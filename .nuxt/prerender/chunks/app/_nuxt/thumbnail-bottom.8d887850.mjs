...
const _sfc_main = {
  ...
  methods: {
    ...
    sizeVariant(id, slideId, color) {
      this.swiper.slideTo(slideId, 1e3, false);
      this.size = [];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper productdetail"><div class="container"><div class="row"><div class="col-lg-4">`);
  ...
  _push(`<h6 class="product-title three-col-text d-flex justify-content-between"> select size <span><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-1">size chart</a></span></h6><div class="size-box"><ul><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/three-column/thumbnail-bottom.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const thumbnailBottom = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { thumbnailBottom as default };
//# sourceMappingURL=thumbnail-bottom.8d887850.mjs.map
