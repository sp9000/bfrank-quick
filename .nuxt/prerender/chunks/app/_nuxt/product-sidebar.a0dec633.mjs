...
import { u as useFilterStore } from './filter.dd288d63.mjs';
...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrRenderAttr } from 'file:///home/sp07/vue/templatian/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="row"><div class="col-xl-12"><div class="filter-main-btn mb-2 ms-3"><button class="filter-btn btn btn-theme"><i class="fa fa-filter" aria-hidden="true"></i> filter </button></div></div></div><div class="${ssrRenderClass([{ "openFilterbar": $data.filter }, "collection-filter"])}"><div class="collection-filter-block"><div class="collection-mobile-back"><span class="filter-back"><i class="fa fa-angle-left" aria-hidden="true"></i> back </span></div><div class="${ssrRenderClass([$data.openBlock ? "open" : "", "collection-collapse-block"])}"><h3 class="collapse-block-title">Category</h3><div class="collection-collapse-block-content"><div class="collection-brand-filter"><ul class="category-list"><li>`);
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              ssrRenderList($options.getCategoryProduct("new products").splice(0, 3), (product, index) => {
                ...
                if (product.sale) {
                  _push3(`<h4${_scopeId2}>${ssrInterpolate($options.curr.symbol)}${ssrInterpolate($options.discountedPrice(product))} <del${_scopeId2}>${ssrInterpolate($options.curr.symbol)}${ssrInterpolate(product.price * $options.currency.curr || $options.currency($options.currency.symbol))}</del></h4>`);
                } else {
                    ...
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "media-body align-self-center" }, [
                        ...
                        product.sale ? (openBlock(), createBlock("h4", { key: 0 }, [
                          ...
                          createVNode("del", null, toDisplayString($options.curr.symbol) + toDisplayString(product.price * $options.currency.curr || $options.currency($options.currency.symbol)), 1)
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                ...
                ssrRenderList($options.getCategoryProduct("new products").splice(3, 3), (product, index) => {
                  ...
                  if (product.sale) {
                    _push3(`<h4${_scopeId2}>${ssrInterpolate($options.curr.symbol)} ${ssrInterpolate($options.discountedPrice(product) * $options.currency.curr || $options.currency($options.currency.symbol))} <del${_scopeId2}>${ssrInterpolate($options.curr.symbol)}${ssrInterpolate(product.price * $options.currency.curr || $options.currency($options.currency.symbol))}</del></h4>`);
                  } else {
                    _push3(`<h4${_scopeId2}>${ssrInterpolate(product.price * $options.currency.curr || $options.currency($options.currency.symbol))}</h4>`);
                  }
                  _push3(`</div></div>`);
                });
                _push3(`<!--]--></div>`);
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList($options.getCategoryProduct("new products").splice(3, 3), (product, index) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "media-body align-self-center" }, [
                          ...
                          product.sale ? (openBlock(), createBlock("h4", { key: 0 }, [
                            createTextVNode(toDisplayString($options.curr.symbol) + " " + toDisplayString($options.discountedPrice(product) * $options.currency.curr || $options.currency($options.currency.symbol)) + " ", 1),
                            createVNode("del", null, toDisplayString($options.curr.symbol) + toDisplayString(product.price * $options.currency.curr || $options.currency($options.currency.symbol)), 1)
                          ])) : (openBlock(), createBlock("h4", { key: 1 }, toDisplayString(product.price * $options.currency.curr || $options.currency($options.currency.symbol)), 1))
                        ])
                      ]);
                    }), 128))
                  ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/widgets/product-sidebar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const productSidebar = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { productSidebar as p };
//# sourceMappingURL=product-sidebar.a0dec633.mjs.map
