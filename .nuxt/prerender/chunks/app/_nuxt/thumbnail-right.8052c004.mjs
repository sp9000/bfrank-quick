...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper"><div class="container"><div class="row"><div class="col-lg-3 col-sm-10 col-xs-12 order-up">`);
  ...
  _push(`</div><div class="col-lg-1 col-sm-2 col-xs-12"><div class="row"><div class="col-12 slider-nav-images">`);
  _push(ssrRenderComponent(_component_swiper, {
  ...
  _push(`</div></div></div><div class="col-lg-4"><div class="product-right product-description-box"><h2>${ssrInterpolate($options.getDetail.title)}</h2><div class="border-product"><h6 class="product-title">product details</h6><p>${ssrInterpolate($options.getDetail.description.substring(0, 200) + "....")}</p></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/three-column/thumbnail-right.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const thumbnailRight = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { thumbnailRight as default };
//# sourceMappingURL=thumbnail-right.8052c004.mjs.map
