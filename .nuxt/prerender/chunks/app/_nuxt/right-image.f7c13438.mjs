...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper"><div class="container"><div class="row"><div class="col-lg-5 col-sm-10">`);
  ...
  _push(`</div><div class="col-lg-1 col-sm-2"><div class="row"><div class="col-12 p-0 slider-nav-images">`);
  _push(ssrRenderComponent(_component_swiper, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/thumbnail-image/right-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const rightImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { rightImage as default };
//# sourceMappingURL=right-image.f7c13438.mjs.map
