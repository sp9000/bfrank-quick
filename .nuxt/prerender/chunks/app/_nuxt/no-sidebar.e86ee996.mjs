...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderStyle } from 'file:///home/sp07/vue/templatian/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--]--></div></div>`);
  if (_ctx.productslist.length > $data.paginate) {
    ...
    ssrRenderList($data.pages, (page_index, index) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/collection/no-sidebar.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const noSidebar = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { noSidebar as default };
//# sourceMappingURL=no-sidebar.e86ee996.mjs.map
