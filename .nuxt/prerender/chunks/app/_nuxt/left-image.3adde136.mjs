...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper"><div class="container"><div class="row"><div class="col-lg-1 col-sm-2"><div class="row"><div class="col-12 p-0 slider-nav-images">`);
        ...
        ssrRenderList($options.getDetail.images, (product, index) => {
          _push2(ssrRenderComponent(_component_swiper_slide, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("src", $options.getImgUrl(product.src))}${ssrRenderAttr("id", product.image_id)} class="img-fluid" alt="product.alt"${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
  ...
  _push(`</div></div></div><div class="col-lg-5 col-sm-10 order-up">`);
  _push(ssrRenderComponent(_component_swiper, {
      ...
      if (_push2) {
        ...
        ssrRenderList($options.getDetail.images, (product, index) => {
          _push2(ssrRenderComponent(_component_swiper_slide, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<img${ssrRenderAttr("src", $options.getImgUrl(product.src))}${ssrRenderAttr("id", product.image_id)} class="img-fluid"${ssrRenderAttr("alt", product.alt)}${_scopeId2}>`);
              } else {
                return [
                  createVNode("img", {
                    src: $options.getImgUrl(product.src),
  ...
  _push(`</div><div class="col-lg-6 rtl-text"><div class="product-right"><h2>${ssrInterpolate($options.getDetail.title)}</h2>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/thumbnail-image/left-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const leftImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { leftImage as default };
//# sourceMappingURL=left-image.3adde136.mjs.map
