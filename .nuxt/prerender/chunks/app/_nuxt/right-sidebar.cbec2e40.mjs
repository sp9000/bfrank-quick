...
import { p as productSidebar } from './product-sidebar.a0dec633.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_productSidebar = resolveComponent("productSidebar");
  ...
  _push(`<section class="section-b-space"><div class="collection-wrapper"><div class="container"><div class="row"><div class="col-lg-9 col-sm-12 productdetail"><div class="container-fluid"><div class="row"><div class="col-lg-6">`);
