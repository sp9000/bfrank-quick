...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/collection/list-view.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const listView = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { listView as default };
//# sourceMappingURL=list-view.cf6808a4.mjs.map
