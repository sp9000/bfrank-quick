...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper ratio_asos"><div class="container"><div class="row"><div class="col-lg-6"><div class="row product_image_4"><!--[-->`);
  ssrRenderList($options.getDetail.images, (product, index) => {
    _push(`<div class="col-6"><div><img${ssrRenderAttr("src", $options.getImgUrl(product.src))}${ssrRenderAttr("id", product.image_id)} class="img-fluid bg-img"${ssrRenderAttr("alt", product.alt)}></div></div>`);
  });
  _push(`<!--]--></div></div><div class="col-lg-6 rtl-text"><div class="product-right"><h2>${ssrInterpolate($options.getDetail.title)}</h2>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/four-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const fourImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { fourImage as default };
//# sourceMappingURL=four-image.b710d49d.mjs.map
