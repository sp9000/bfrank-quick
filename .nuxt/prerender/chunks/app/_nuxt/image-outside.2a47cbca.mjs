...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="col-lg-6 rtl-text"><div class="row"><div class="col-12"><div class="product-right"><h2>${ssrInterpolate($options.getDetail.title)}</h2>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/thumbnail-image/image-outside.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageOutside = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { imageOutside as default };
//# sourceMappingURL=image-outside.2a47cbca.mjs.map
