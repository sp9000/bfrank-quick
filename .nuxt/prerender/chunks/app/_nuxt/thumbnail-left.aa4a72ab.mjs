import { m as mapState, e as useProductStore, f as useCartStore, b as _export_sfc, c as __nuxt_component_0$1 } from '../server.mjs';
...
import { r as relatedProduct, _ as _imports_0$1 } from './size-chart.0683afd0.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderStyle, ssrRenderClass, ssrIncludeBooleanAttr } from 'file:///home/sp07/vue/templatian/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_0, a as _imports_1, b as _imports_2, c as _imports_3, d as _imports_4 } from './discover.5287eaca.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<section><div class="collection-wrapper"><div class="container"><div class="row"><div class="col-lg-1 col-sm-2 col-xs-12"><div class="row"><div class="col-12 slider-nav-images">`);
  ...
  _push(`</div></div></div><div class="col-lg-3 col-sm-10 col-xs-12 order-up">`);
  _push(ssrRenderComponent(_component_swiper, {
  ...
  _push(`</div><div class="col-lg-4"><div class="product-right product-description-box"><h2>${ssrInterpolate($options.getDetail.title)}</h2><div class="border-product"><h6 class="product-title">product details</h6><p>${ssrInterpolate($options.getDetail.description.substring(0, 200) + "....")}</p></div>`);
  ...
  _push(`<div class="single-product-tables border-product detail-section"><table><tbody><tr><td>Product Type:</td><td>${ssrInterpolate($options.getDetail.type)}</td></tr><tr><td>Brand:</td><td>${ssrInterpolate($options.getDetail.brand)}</td></tr><tr><td>Material:</td><td>Crepe printed</td></tr></tbody></table></div><div class="border-product"><h6 class="product-title">share it</h6><div class="product-icon"><ul class="product-social"><li><a href="javascript:void(0)"><i class="fa fa-facebook"></i></a></li><li><a href="javascript:void(0)"><i class="fa fa-google-plus"></i></a></li><li><a href="javascript:void(0)"><i class="fa fa-twitter"></i></a></li><li><a href="javascript:void(0)"><i class="fa fa-instagram"></i></a></li><li><a href="javascript:void(0)"><i class="fa fa-rss"></i></a></li></ul><form class="d-inline-block"><button class="wishlist-btn"><i class="fa fa-heart"></i><span class="title-font">Add To WishList</span></button></form></div></div><div class="border-product"><h6 class="product-title">100% SECURE PAYMENT</h6><div class="payment-card-bottom"><ul><li><a href="javascript:void(0)"><img${ssrRenderAttr("src", _imports_0)} alt=""></a></li><li><a href="javascript:void(0)"><img${ssrRenderAttr("src", _imports_1)} alt=""></a></li><li><a href="javascript:void(0)"><img${ssrRenderAttr("src", _imports_2)} alt=""></a></li><li><a href="javascript:void(0)"><img${ssrRenderAttr("src", _imports_3)} alt=""></a></li><li><a href="javascript:void(0)"><img${ssrRenderAttr("src", _imports_4)} alt=""></a></li></ul></div></div></div></div><div class="col-lg-4"><div class="product-right product-form-box">`);
  if ($options.getDetail.sale) {
    _push(`<h4><del>{curr.symbol}}${ssrInterpolate(($options.getDetail.price * $options.curr.curr).toFixed(2))}</del><span>${ssrInterpolate($options.getDetail.discount)}% off</span></h4>`);
  } else {
    _push(`<!---->`);
  }
  if ($options.getDetail.sale) {
  ...
  _push(`<!--]--></ul><div class="product-description border-product"><h6 class="product-title">Time Reminder</h6>`);
  _push(ssrRenderComponent(_component_Timer, { date: "December 20, 2020" }, null, _parent));
  _push(`<h6 class="product-title three-col-text"> select size <span><a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-1">size chart</a></span></h6><div class="size-box"><ul><!--[-->`);
