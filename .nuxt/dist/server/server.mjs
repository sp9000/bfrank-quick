...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth.52cf7e4b.js")
};
...
function createComposer(options = {}, VueI18nLegacy) {
  ...
  const wrapWithDeps = (fn, argumentParser, warnType, fallbackSuccess, fallbackFail, successCondition) => {
    ...
    if (shared$1.exports.isNumber(ret) && ret === NOT_REOSLVED) {
      ...
      if (process.env.NODE_ENV !== "production" && __root && shared$1.exports.isString(key) && isResolvedTranslateMessage(warnType, arg2)) {
...
function createI18n(options = {}, VueI18nLegacy) {
  ...
  const symbol = /* @__PURE__ */ shared$1.exports.makeSymbol(process.env.NODE_ENV !== "production" ? "vue-i18n" : "");
