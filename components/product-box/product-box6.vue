  ...
  <div>
    <div class="img-wrapper">
      ...
      <div class="cart-info cart-wrap">
        ...
        <a href="javascript:void(0)" title="Comapre" @click="addToCompare(product)" v-b-modal.modal-compare
          variant="primary">
          <i class="ti-reload" aria-hidden="true"></i>
        </a>
      </div>
      <div class="addtocart_btn">
        <button data-toggle="modal" data-target="#addtocart" class="add-button add_cart" @click="addToCart(product)">
          add to cart
        </button>
      </div>
    </div>
