            ...
            <swiper  :breakpoints="swiperOption.breakpoints" :slidesPerView="4" :spaceBetween="20"
              ...
              <swiper-slide class="swiper-slide" v-for="(product, index) in products" :key="index">
                <div class="product-box">
                  <productBox5 @opencartmodel="showCartModal" @showCompareModal="showcomparemodal"
...
import 'swiper/css';
import productBox5 from '../../product-box/product-box5'
export default {
  props: ['products'],
  components: {
    productBox5, Swiper, SwiperSlide
  },
  data() {
    return {
