<template>
  <div>
    <div class="full-banner gym-parallax parallax p-0" v-bind:style="{ 'background-image': `url(${imagepath})` }">
      <div class="section-t-space section-b-space gym-product">
        <div class="container">
          ...
          <div class="row part-cls">
            <div class="col-xl-3 col-sm-6" v-for="(product, index) in getCategoryProduct(category[1])" :key="index">
...
export default {
  ...
  data() {
    return {
      imagepath: '/images/parallax/25.jpg',
